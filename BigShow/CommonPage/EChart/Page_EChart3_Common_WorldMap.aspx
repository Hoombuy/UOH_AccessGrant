<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page_EChart3_Common_WorldMap.aspx.cs" Inherits="CommonPage.EChart.Page_EChart3_Common_WorldMap" %>
...
<head runat="server">
    ...
    <script src="/js/Echart3/map/js/world.js"></script>
</head>
<body>
        ...
        <div class="col-sm-12" style="text-align: center;">
            <div id="Div1" class="widget" runat="server" style="margin-left: auto; margin-right: auto;">
                <div class="widget-content">
                    <div id="main" style="height: 600px; width: 700px;" runat="server">
                    </div>
                </div>
            </div>
        </div>
